...
BEGIN
    DECLARE @BranchId bigint = (SELECT TOP 1 Id FROM dbo.Branches WHERE IsDeleted = 0 ORDER BY Id);

    INSERT INTO dbo.Users
        (CreatedAt, UpdatedAt, IsDeleted, Username, Name, LastName, Password, Phone, BranchId, Picture, Role)
    VALUES
        (SYSUTCDATETIME(), NULL, 0, 'superadmin', 'Super', 'Admin',
         LOWER(CONVERT(varchar(64), HASHBYTES('SHA2_256', 'Kordena#2026!'), 2)),
         0, @BranchId, '', 'SuperAdmin');
END;
GO
